...
{% include highlights.html 
content_txt="
Instead, **variational inference** will bring us closer to the solution. It is /c/a method that approximates the posterior distribution through optimization/c/. 
...
other common distributions, such as the gamma or beta, without using further approximations. {% include linking_source.html no="3" %}
...
Their gradient estimator is a combination of the reparameterization-trick term that we have calculated before and the gradient estimator 
of the BBVI:
