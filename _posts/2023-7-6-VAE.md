...
{% include highlights.html 
content_txt="Some of you may know that /c/finding a proper data representation/c/, that includes extracting relevant features of the data, will increase the chances 
...
{% include highlights.html 
content_txt="
Instead, **variational inference** will bring us closer to the solution. It is /c/a method that approximates probability density functions through optimization/c/. The basic approach is to create a family of possible densities and with a distance measure to find the density from this family that is the closest to the one we want to approximate.
"%}
